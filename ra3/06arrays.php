...
<body>
  ...
  <h1 style="text-decoration: underline;">Arrays</h1>
  ...
  <h3 style="text-decoration: underline;">Array escalar</h3>
  ...
  // Si solo se indican los elementos del array, cada uno tiene su clave según el orden en el que aparecen, comenzando por 0.
  ...
  // No es obligatorio que PHP asigne índices a los elmentos del array. Podemos asignárselo nosotros.
  ...
  // Puedo asignar un lugar a un componente y que los siguientes sean asignados automáticamente.
  ...
  // Borrado de elementos. La función unset($variable)
  echo "<p>";
  unset($notas[4]);
  if (isset($notas[4])) {
  ...
  <h3 style="text-decoration: underline;">Arrays asociativos</h3>
  ...
  <h3 style="text-decoration: underline;">Array mixtos</h3>
  ...
  <h3 style="text-decoration: underline;">Arrays bidimensionales</h3>
  <p>Arrays de dos dimensiones es cuando cada elemento de un array es otro array. En este caso
    para acceder a elementos individuales hay que utilizar 2 claves.</p>
  ...
  <h3 style="text-decoration: underline;">Arrays multidimensionales</h3>
