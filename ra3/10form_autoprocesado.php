...
inicioHtml("10. Paginas autoprocesadas", ["/estilos/general.css", "/estilos/formulario.css"]);

/* Pagina autoprocesada
  =======================
   Consiste en incluir en el mismo script el formulario y el procesamiento del mismo.
   - Si la peticion es GET, se presenta el formulario.
   - Si la peticion es POST, se procesa el formulario.
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  echo "<p>Puede rellenar otra respuesta <a href='{$_SERVER['PHP_SELF']}'>aqui</a></p>";
}
