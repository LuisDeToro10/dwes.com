...
<body>
  ...
  <h1 style="text-decoration: underline;">Estructuras de control</h1>
  <h2 style="text-decoration: underline;">Sentencias</h2>
  <p>Las sentencias simples acaban en ;, pudiendo haber más de una en una misma línea</p>
  ...
  <p>Un bloque de sentencias es un conjunto de sentencias simples encerradas entre llaves. No suelen ir sueltas, sino formar parte de una estructura de control. Además, se pueden anidar.</p>
  ...
  */
  ...
  <h3 style="text-decoration: underline;">Estructura condicional compuesta</h3>
  ...
  if ($tipoCarnet === "C1")
    echo <<<CARNETB1
  <h2 style='text-decoration: underline;'>Documentación para solicitar la tarjeta de transporte</h2>
  <ul>
...
*/
  ...
  <h2 style="text-decoration: underline;">Bucles</h2>
  <ul>
  ...
  */
  ...
  // Bucle para contar cuantos números impares entre 1 y 100 se generan aleatoramiente hasta que se genere el 0, pero que no sean múltiplo de 3
  $numero = rand(0, 100);
  $impares = 0;
  $multiplos_3 = 0;
  ...
  <h3 style="text-decoration: underline";>Sintaxis alternativa a las estructuras de control</h3>
