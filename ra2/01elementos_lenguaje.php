...
<head>
  <meta charset="utf-8">
  <title>01. Elementos del lenguaje</title>
  <link rel="stylesheet" href="../estilos/general.css">
</head>

<body>
  <h1 style="text-align: center;">01. Elementos del lenguaje</h1>
  ...
  echo "<p>Cuando hay que enviar a la salida el resultado de una expresión pequeña disponemos de la forma abreviada de echo que permite intercarlarse en el código HTML con menos esfuerzo y más legible</p>";
  ...
  printf("La circunferencia de radio %d es %1$010.2f", $radio, $circunferencia);
  ?>
