...
<html lang="es">
  ...
  <body>
    ...
    <p>La entrada de datos en PHP es con un formulario o enlace. La salida se produce con la función echo, y su forma abreviada, y la función print. Además, tenemos la función printf para salida con formato.
    </p>
    <h3 style="text-decoration: underline;">Función echo</h3>
...
echo "<h4 style='text-decoration: underline;'>Forma abreviada de echo</h4>";
...
<!-- Función print -->
<h4 style="text-decoration: underline;">Función print</h4>
...
echo "<h4 style='text-decoration: underline;'>Función printf()</h4>";
