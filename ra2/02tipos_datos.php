...
<h1 style="text-decoration: underline;">Tipos de datos</h1>
...
<p>En PHP los números enteros son de 32 bits. Pueden expresarse en diferentes notaciones</p>
...
// Los números enteros se almacenan en memoria en el sistema decimal aunque los haya expresado en diferentes notaciones.
...
<h2 style="text-decoration: underline;">Números en coma flotante</h2>
<p>El separador decimal es el punto . y se pueden expresar números muy grandes o muy pequeños con notación científica</p>
...
<p>El tipo string o cadena de caracteres es una serie de caracteres donde cada caracter equivale a un byte. PHP solo admite 256 caracteres, las cadenas están en ASCII y no hay soporte utf8. Hay 4 formas de expresar una cadena de caracteres:</p>
  <ul>
...
<?php
// Una cadena de caracteres entre comillas simples no reconoce ningún carácter de escape excepto \' y \\ y además, no podemos interpolar variables.
...
<p>Es una cadena muy larga, incluyendo saltos de línea que se respetan, que comienza por <<< y un identificador (generalmente en mayúsculas). Justo después hay un salto de línea y se escribe la cadena, con saltos de línea que sean necesarios, con interporlación de variables y caracteres de escape. Para finalizar la cadena se hace un salto de línea y se vuelve a poner el mismo identificador</p>
...
<p>La cadena Nowdoc es como Heredoc pero con comillas simples. No se interpolan variables ni se reconocen secuencias de escapa más allá de \ y '. No se respetan los saltos de línea</p>
...
<h2 style="text-decoration: underline;">Conversión de tipos</h2>
<p>Hay dos tipos de conversiones de tipos: implícitas y explícitas. Las primeras ocurren cuando en una expresión hay operandos de diferente tipo. PHP convierte algunos de ellos para evaluar la expresión.</p>
...
echo <<<IMPORTANTE
<p style="background-color:yellow";>¡¡¡IMPORTANTE!!! Cuando se haga la conversión implícita solo afecta al operando durante la 
