...
<h1 style="text-decoration: underline;">Variables</h1>
...
// Si utilizo una variable que no está declarada (a la que todavía no le he asignado valor ), entonces es undefined.
$resultado = $num + 4;
echo "<p>El resultado es $resultado</p>";
?>

<h2 style="text-decoration: underline;">Análisis de variables</h2>
<h3 style="text-decoration: underline;">Análisis simple</h3>

<?php
// Consiste en introducir una variable en una cadena con " o heredoc para incrustar su valor dentro de la cadena.
$num = 5;
echo "<p>Variable num interpolada: $num</p>"
?>

<h3 style="text-decoration: underline;">Análisis complejo</h3>
...
<h2 style="text-decoration: underline;">Funciones para variables</h2>
...
// Función empty() -> Devuelve true si una variable está vacía. Comprueba que la variable tenga un valor
...
// Función isset() -> Devuelve true si la variable está definida y con un valor distinto de null, false en caso contrario
...
<h2 style="text-decoration: underline;">Constantes</h2>
<p>Una constante es un valor con nombre que no puede cambiar de valor a lo largo del programa. Se le asigna un valor en la declaración y permanece invariable. Hay 2 formas de definir una constante:
    <ul>
