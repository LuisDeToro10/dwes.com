...
<h1 style="text-decoration: underline;">Expresiones, operadores y operandos</h1>
<p>Una expresión es una combinación de operandos y operadores que arroja un resultado. Tiene un tipo de datos, que depende del tipo de datos de sus operandos y de la operación realizada.<br>Un operador es un símbolo formado por uno, dos o tres caracteres que denota una operación.<br>Los operadores pueden ser:
  <ul>
    <li>Unarios -> Solo necesitan un operando.</li>
    <li>Binarios -> Necesitan dos operandos.</li>
    <li>Ternarios -> Utilizan 3 operandos.
  </ul>
  Un operando es una expresión en si misma, siendo la más simple un literal o una variable, pero también puede ser un valor devuelto por una función o el resultado de otra expresión.<br>Las operaciones de una expresión no se ejecutan a la vez, sino en un orden según la precedencia (prioridad) y asociatividad del operador. Esto se puede cambiar a conveniencia.
</p>
<h2 style="text-decoration: underline;">Operadores</h2>
<h3 style="text-decoration: underline;">Asignación</h3>
...
<h3 style="text-decoration: underline;">Aritméticos</h3>
...
<h3 style="text-decoration: underline;">Asignación aumentada</h3>

<?php
/* Operadores de asignación aumentada. Además de una operación aritmética, hay una asignación
...
<h2 style="text-decoration: underline;">Operadores relacionales</h2>
...
<h2 style="text-decoration: underline;">Operadores lógicos</h2>
<p>Los operadores lógicos unen expresiones relacionales construidas con los operadores relacionales anteriores. Arrojan un resultado booleano en función de las tablas de verdad.

<?php
/*
  AND -> Operador lógico AND. True si ambas expresiones son true, false en caso contrario.
  OR  -> Operador lógico OR. True si alguna de las expresiones es true, false si ambas expresiones son false.
  XOR -> Operador lógico OR exclusivo. True si una, y solo una, de las expresiones es true, false ambas de la expresiones son true o false.
...
<h2 style="text-decoration: underline;">Precedencia y asociatividad</h2>
<p>En una expresión con múltiples operadores se ejecutan en un determinado orden dictado por la precedencia de cada operador. Si hay más de un operador con la misma precedencia, se aplica la asociatividad.
</p>
